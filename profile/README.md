# Hi there , we are TapX Studio | 你好！这里是 TapX 工作室！


> A community of Minecraft enthusiasts dedicated to building a stable, secure, and free platform for public Minecraft services.
> 由一群 Minecraft 爱好者创建，致力于构建一个稳定、安全、免费的 Minecraft 公益服务平台。
...
We welcome developers, designers, documentation maintainers, community helper, and other contributors to join our community and help improve the projects.
我们非常欢迎开发者、设计师、文档维护者、社区维护者以及其他贡献者加入我们的社区，共同推动项目的进步。​

### How to Contribute | 如何参与贡献：

Submit issues and suggestions via GitHub Issues. | 提交 Issues，表达您的建议或反馈您的问题。
Or | 或
Open a Pull Request and describe your changes. | 提交 Pull Request，并描述你的修改内容。
Or | 或
Connect with us via hi@mail.mctap.org and join the TapX Studio team. | 透过 hi@mail.mctap.org 和我们取得联系并加入 TapX 工作室。

---

## 📄 License | 许可证

All projects in TapX Studio are licensed under the [GPL 3.0 License](https://www.gnu.org/licenses/gpl-3.0.html). For more details, please refer to the `LICENSE` file in each repository.

所有 TapX 工作室项目均采用 [GPL 3.0 许可证](https://www.gnu.org/licenses/gpl-3.0.html)，详细内容请查看每个项目根目录下的 `LICENSE` 文件。

---

## 📬 Contact Us | 联系我们

- Official Website: [www.mctap.net](https://www.mctap.net) | 官方网站：[www.mctap.net](https://www.mctap.net)

---

Thank you for your support of TapX Studio! | 最后，由衷的感谢你对TapX Studio的支持！
